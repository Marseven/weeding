...
return [
    ...
    'attributes'           => [
        ...
        'mandatory_number'         => 'numéro obligatoire',
        'key'                      => 'clé',
        'value'                    => 'valeur',
        'fr'                       => 'texte français',
        'en'                       => 'texte anglais',
        'leader_last_name'         => 'nom du leader',
        'leader_portrait_url'      => 'image portrait du leader',
        'current'                  => 'status en cours',
        'start_date'               => 'date de début',
        'end_date'                 => 'date de fin',
        'amount'                   => 'montant',
        'offer_id'                 => 'offre',
        'order_checklist_id'       => 'critère',
        'offer_file_id'            => 'fichier',
        'order_document_id'        => 'document',
        'order_id'                 => 'commande',
        ...
        'publish_datetime'         => 'date de publication',
        'date_end_question'        => 'date de fin de question',
        'close_datetime'           => 'date de clôture',
        'order_category_id'        => 'catégorie de la commande',
        'organizational_unit_id'   => 'unité administrative',
        'question'                 => 'question',
        'user_id'                  => 'utilisateur',
        'code'                     => 'code',
        'type'                     => 'type',
        'provider_document_list_id' => 'document du fournisseur',
        'user_type_id'             => 'type d\'utilisateur',
        'role_id'                  => 'rôle',
        'phone_code'               => 'indicatif du pays',
        'order_budget_treshold_id' => 'palier de budget pour la commande',
        'offer_amount_treshold_id' => 'palier de budget pour l\'offre',
        'company_name'             => 'nom de l\'entreprise',
        'manager_citizenship'      => 'civilité',
        'manager_dob'              => 'date de naissance',
        'manager_pob'              => 'lieu de naissance',
        'rccm'                     => 'RCCM',
        'nif'                      => 'NIF',
        'legal_status_id'          => 'statut légal',
        'business_sector_id'       => 'secteur d\'activité',
        'check_policy'             => 'politique de confidentialité',
        'logo'                     => 'logo',
        'photo_geolocalisation'    => 'photo du bâtiment',
    ],
];
